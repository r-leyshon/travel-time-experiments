...
walth_centroids = walth_centroids[
    ["geometry", "OA21CD",  "snapped_geometry", "lines", "snap_dist_m"]
    ]
walth_polys = walth_polys.reset_index()[["OA21CD", "geometry_l"]]
del oa_polys
del centroids
```
...
med_tts_1 = gpd.GeoDataFrame(med_tts_1, geometry="snapped_geometry", crs=4326)
med_tts_1.head()
```
